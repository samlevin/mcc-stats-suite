...
variable "create_terrateam_role" {
  description = "Create Terrateam access; disable for a locally managed disposable sandbox account."
  type        = bool
  default     = true
}

variable "create_cdk_deploy_role" {
  description = "Create GitHub CDK access; disable for a locally managed disposable sandbox account."
  type        = bool
  default     = true
}
